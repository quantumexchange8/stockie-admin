...
<template>
    <div class="flex flex-col min-w-[372px] max-h-[calc(100dvh-20.5rem)] justify-between items-center shrink-0 rounded-[5px] bg-white/80 overflow-auto scrollbar-webkit scrollbar-thin">
        <div class="flex flex-col items-center gap-6 shrink-0 self-stretch">
            ...
            <div class="flex flex-col items-center gap-6 self-stretch">
                ...
                <div class="flex flex-col items-end gap-[13px] self-stretch" v-if="Object.keys(props.inventory_notifications).length > 0">
                    ...
                    <div class="flex flex-col items-start gap-[13px] self-stretch rounded-[5px] p-3 bg-white/80 hover:bg-[#fff1f280]" v-if="!showMoreInventory">
                        <span class="self-stretch text-grey-900 text-sm font-normal" v-if="firstInventory.type === 'App\\Notifications\\InventoryOutOfStock'">Item 
                        ...
                        <div class="flex items-start gap-[13px] self-stretch cursor-pointer" @click="openFoldedInventory">
                        ...
                        <div class="flex flex-col p-3 items-end gap-[13px] self-stretch">
                            <div class="flex justify-end items-start gap-[13px] self-stretch">
                                ...
                                <div class="flex flex-col justify-center items-start gap-1 flex-[1_0_0]">
                                    <template v-if="firstWaiter.type === 'App\\Notifications\\WaiterCheckIn'">
                            ...
                            <div class="flex items-start gap-[13px] self-stretch cursor-pointer" @click="openFoldedWaiter">
                        ...
                        <div class="flex flex-col items-end gap-[13px] self-stretch">
                            <div class="flex flex-col p-3 items-end gap-[13px] self-stretch">
                                <div class="flex justify-end items-start gap-[13px] self-stretch">
                                    ...
                                    >
                                    <div class="flex flex-col justify-center items-start gap-1 flex-[1_0_0]">
                                        <template v-if="waiters.type === 'App\\Notifications\\WaiterCheckIn'">
                                            <div class="flex items-center gap-1 self-stretch">
                                                <span class="bg-green-600 size-2 rounded-full"></span>
                ...
                <div class="flex flex-col items-end gap-[13px] self-stretch" v-if="Object.keys(props.order_notifications).length > 0">
                    ...
                    <div class="flex flex-col items-end gap-[13px] self-stretch rounded-[5px] bg-white hover:bg-[#fff1f280] p-3" v-if="!showMoreOrder">
                        <div class="flex items-end gap-[13px] self-stretch">
                            <div class="flex justify-start items-start gap-[13px] self-stretch size-9">
                                <img :src="firstOrder.data.image ? firstOrder.data.image : 'https://www.its.ac.id/tmesin/wp-content/uploads/sites/22/2022/07/no-image.png'"
                                    alt=""
                                    class=""
                                    v-if="firstOrder.type === 'App\\Notifications\\OrderPlaced'"
                                />
                            ...
                            <div class="flex flex-col justify-center items-start gap-1 flex-[1_0_0]">
                                <div class="flex items-center gap-1 self-stretch">
                                    <div class="size-2 rounded-full bg-green-600" v-if="firstOrder.type === 'App\\Notifications\\OrderPlaced'"></div>
                                    <span class="line-clamp-1 flex-[1_0_0] text-ellipsis text-primary-900 text-xs font-medium">
                                        {{ firstOrder.type === 'App\\Notifications\\OrderPlaced' ? firstOrder.data.waiter_name : firstOrder.data.table_no }}
                                    </span>
                                </div>
                                <span class="text-grey-900 text-sm font-normal" v-if="firstOrder.type === 'App\\Notifications\\OrderPlaced'">
                        ...
                        <div class="flex items-start gap-[13px] self-stretch cursor-pointer" @click="openFoldedOrder">
                        ...
                        <div class="flex items-end gap-[13px] self-stretch">
                            <div class="flex justify-start items-start gap-[13px] self-stretch size-9">
                                <img :src="orders.data.image ? orders.data.image : 'https://www.its.ac.id/tmesin/wp-content/uploads/sites/22/2022/07/no-image.png'"
                                    alt=""
                                    class=""
                                    v-if="orders.type === 'App\\Notifications\\OrderPlaced'"
                                />
                                <div class="flex relative size-9" v-else>
                                    <img 
                            ...
                            <div class="flex flex-col justify-center items-start gap-1 flex-[1_0_0]">
                                <div class="flex items-center gap-1 self-stretch">
                                    <div class="size-2 rounded-full bg-green-600" v-if="orders.type === 'App\\Notifications\\OrderPlaced'"></div>
                                    <span class="line-clamp-1 flex-[1_0_0] text-ellipsis text-primary-900 text-xs font-medium">
                                        {{ orders.type === 'App\\Notifications\\OrderPlaced' ? orders.data.waiter_name : orders.data.table_no }}
                                    </span>
                                </div>
                                <span class="text-grey-900 text-sm font-normal" v-if="orders.type === 'App\\Notifications\\OrderPlaced'">
                ...
                <div class="flex flex-col items-center">
                    ...
                    >
                        View all notification ({{ props.notificationLength }})
                    </Button>
                </div>
            </div>
        </div>
