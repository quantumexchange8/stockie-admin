...
<template>
    <form @submit.prevent="submit">
        <div class="flex flex-col items-start gap-6 rounded-[5px] bg-white">
                ...
                <template v-for="product in filterProducts" :key="product.index">
                    <div class="flex justify-between items-center self-stretch py-2.5">
                        <div class="flex items-center gap-3">
                            <div class="w-[60px] h-[60px] flex-shrink-0 rounded-[1.5px] border-[0.3px] border-solid border-grey-100 bg-primary-300">
            ...
            <div class="flex flex-col p-6 justify-end items-center gap-5 self-stretch">
