...
<template>
    <div class="w-full h-full flex flex-col py-6 item-center shrink-0 rounded-[5px] border border-solid border-primary-100">
        ...
        <template v-else>
            <div class="flex flex-col px-6 justify-center items-center gap-2.5 flex-[1_0_0] self-stretch">
                <div class="flex flex-col justify-center items-center gap-5">
                    <EmptyActivityIllust />
                    <span class="text-primary-900 text-sm font-medium">No activity can be shown yet...</span>
                </div>
            </div>
        </template>
    </div>
