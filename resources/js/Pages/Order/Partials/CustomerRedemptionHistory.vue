                            ...
                            <div class="flex flex-col justify-center items-start gap-2 flex-[1_0_0]">
                                ...
                                <div class="flex justify-between items-center self-stretch">
                                    ...
                                    <div class="flex flex-col justify-center items-end gap-3">
                                        <span class="text-green-700 text-base font-medium whitespace-nowrap" v-if="Number(item.new_balance) >= Number(item.old_balance)">+ {{ formatPoints(item.amount) }} {{ $t('public.pts') }}</span>
                                        <span class="text-primary-700 text-base font-medium" v-if="Number(item.new_balance) < Number(item.old_balance)">- {{ formatPoints(item.amount) }} {{ $t('public.pts') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
